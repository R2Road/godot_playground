...
func _ready():
	...
	pam.add_mover( "Keyboard Input", 	Key.KEY_6, 		"res://basic/basic_input_keyboard.tscn" )
	pam.add_mover( "Get Node", 			Key.KEY_7, 		"res://basic/basic_getnode.tscn" )
	pam.add_lf()
	pam.add_mover( "Instantiate + Preload",		Key.KEY_Q,	"res://basic/basic_instantiate_preload.tscn" )
	pam.add_mover( "Instantiate + Load",		Key.KEY_W,	"res://basic/basic_instantiate_load.tscn" )
	pam.add_mover( "Instantiate + PackedScene",	Key.KEY_E,	"res://basic/basic_instantiate_packedscene.tscn" )
	pam.add_lf()
