...
func _ready():
	...
	pam.add_lf()
	pam.add_mover( config___parse.scene_name(),		Key.KEY_1, config___parse.scene_path() )
	pam.add_mover( config___section.scene_name(),	Key.KEY_2, config___section.scene_path() )
