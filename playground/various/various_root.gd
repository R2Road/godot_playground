...
func _ready():
	...
	pam.add_lf()
	pam.add_root( audio_root.scene_name(),		Key.KEY_A, 		audio_root.scene_path() )
	pam.add_root( json_root.scene_name(),		Key.KEY_S, 		json_root.scene_path() )
	pam.add_root( config_root.scene_name(),		Key.KEY_D, 		config_root.scene_path() )
